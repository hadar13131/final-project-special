...
class ShowImproveGraps:
    ...
    def show_graph1_on_click(self, e: ft.ControlEvent) -> None:
        ...
        if exercise_name and s_date and e_date:
            if s_date > e_date:
                ...
                self.show_graph1(exercise_name=exercise_name, s_date=s_date, e_date=e_date)
            ...
            ft.Container(
                ...
                content=ft.Column(
                    [
                        ...
                        ft.ElevatedButton(text="change details", on_click=self.show_graph1_on_click, bgcolor='#8532B8',
                                          color='white'),
                    ]
                )
            ),
    ...
    def click_count_sets(self, e: ft.ControlEvent):
        self.page.clean()
        self.show_graph1(exercise_name=self.exercise_name.value, s_date=self.s_date, e_date=self.e_date)

        self.show_graph2(exercise_name1=self.exercise_name.value, s_date=self.s_date, e_date=self.e_date, lst=self.count_sets_l,
    ...
    def click_repete(self, e: ft.ControlEvent):
        ...
        self.show_graph2(exercise_name1=self.exercise_name.value, s_date=self.s_date, e_date=self.e_date, lst=self.avgrepete_l,
    ...
    def click_time(self, e: ft.ControlEvent):
        ...
        self.show_graph2(exercise_name=self.exercise_name.value, s_date=self.s_date, e_date=self.e_date, lst=self.avgtime_l,
    ...
    def click_weight(self, e: ft.ControlEvent):
        ...
        self.show_graph2(exercise_name=self.exercise_name.value, s_date=self.s_date, e_date=self.e_date, lst=self.avgweight_l,
    ...
    def click_distance_KM(self, e: ft.ControlEvent):
        ...
        self.show_graph2(exercise_name=self.exercise_name.value, s_date=self.s_date, e_date=self.e_date, lst=self.avgdistance_KM_l,
